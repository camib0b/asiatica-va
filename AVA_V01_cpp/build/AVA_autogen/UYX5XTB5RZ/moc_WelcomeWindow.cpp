...
template <> constexpr inline auto WelcomeWindow::qt_create_metaobjectdata<qt_meta_tag_ZN13WelcomeWindowE_t>()
{
    ...
    QtMocHelpers::StringRefStorage qt_stringData {
        "WelcomeWindow",
        "videoImportRequested",
        "",
        "applyUiStrings"
    };

    QtMocHelpers::UintData qt_methods {
        // Signal 'videoImportRequested'
...
void WelcomeWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->videoImportRequested(); break;
        case 1: _t->applyUiStrings(); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (WelcomeWindow::*)()>(_a, &WelcomeWindow::videoImportRequested, 0))
            return;
    }
}
...
// SIGNAL 0
void WelcomeWindow::videoImportRequested()
{
