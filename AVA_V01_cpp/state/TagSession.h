...
public:
  struct GameTag {
    ...
    qint64 markMs = 0;      // Event mark (click moment): the anchor used for table seek/highlight.
  ...
  void applyDefaultsToUntrimmedTags(const QString& mainEvent, qint64 leadMs, qint64 lagMs);
