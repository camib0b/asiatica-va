...
QString trUi(const char* key) {
  ...
  if (g_language != Language::Spanish) {
    static const QHash<QString, QString> en = {
        ...
        {QStringLiteral("presentation.panel_title"), QStringLiteral("Clips to present")},
        ...
        {QStringLiteral("presentation.empty_hint"),
         QStringLiteral("Tick the instances you want to present, then press Tab to start.")},
  ...
  static const QHash<QString, QString> es = {
      ...
      {QStringLiteral("presentation.panel_title"), QStringLiteral("Clips para presentar")},
      ...
      {QStringLiteral("presentation.empty_title"), QStringLiteral("Ningún clip seleccionado")},
      {QStringLiteral("presentation.empty_hint"),
       QStringLiteral("Marca las instancias que quieras presentar y pulsa Tab para empezar.")},
