...
QString trUi(const char* key) {
  ...
  if (g_language != Language::Spanish) {
    static const QHash<QString, QString> en = {
        ...
        {QStringLiteral("vc.tt.mute"), QStringLiteral("Mute")},
        {QStringLiteral("vc.tt.unmute"), QStringLiteral("Unmute")},
  ...
  static const QHash<QString, QString> es = {
      ...
      {QStringLiteral("vc.tt.forward"), QStringLiteral("⟶  Adelante")},
        ...
        {QStringLiteral("vc.tt.mute"), QStringLiteral("Silenciar")},
        {QStringLiteral("vc.tt.unmute"), QStringLiteral("Activar audio")},
