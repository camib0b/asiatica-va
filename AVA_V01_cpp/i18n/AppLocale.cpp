...
QString trUi(const char* key) {
  ...
  if (g_language != Language::Spanish) {
    static const QHash<QString, QString> en = {
        ...
        {QStringLiteral("setup.placeholder_home_team"), QStringLiteral("Home team")},
        {QStringLiteral("setup.placeholder_away_team"), QStringLiteral("Away team")},
        ...
        {QStringLiteral("setup.optional"), QStringLiteral("Optional")},
        {QStringLiteral("setup.ai_status_teams"), QStringLiteral("Identifying teams from the file name…")},
        {QStringLiteral("setup.ai_status_colors"), QStringLiteral("Detecting kit colors…")},
        {QStringLiteral("setup.color_more"), QStringLiteral("More colors…")},
        {QStringLiteral("setup.color_choose"), QStringLiteral("Choose color")},
        {QStringLiteral("setup.color_code"), QStringLiteral("Color code")},
        {QStringLiteral("setup.color_red"), QStringLiteral("Red")},
        {QStringLiteral("setup.color_light_blue"), QStringLiteral("Light blue")},
        {QStringLiteral("setup.color_dark_blue"), QStringLiteral("Dark blue")},
        {QStringLiteral("setup.color_yellow"), QStringLiteral("Yellow")},
        {QStringLiteral("setup.color_gray"), QStringLiteral("Gray")},
        {QStringLiteral("setup.color_brown"), QStringLiteral("Brown")},
        {QStringLiteral("setup.color_white"), QStringLiteral("White")},
        {QStringLiteral("setup.color_black"), QStringLiteral("Black")},
        {QStringLiteral("setup.color_green"), QStringLiteral("Green")},
        {QStringLiteral("setup.color_pink"), QStringLiteral("Pink")},
        ...
        {QStringLiteral("mode.presenting"), QStringLiteral("Presentation")},
        ...
        {QStringLiteral("presentation.panel_title"), QStringLiteral("Selected clips")},
        {QStringLiteral("presentation.filter_event"), QStringLiteral("Event:")},
        {QStringLiteral("presentation.filter_team"), QStringLiteral("Team:")},
        {QStringLiteral("presentation.team_all"), QStringLiteral("Both")},
        {QStringLiteral("presentation.all_events"), QStringLiteral("All events")},
        {QStringLiteral("presentation.select_all"), QStringLiteral("Select all")},
        {QStringLiteral("presentation.select_none"), QStringLiteral("Clear")},
        {QStringLiteral("presentation.selection_summary"), QStringLiteral("%1 selected · %2 listed")},
        {QStringLiteral("presentation.current_clip"), QStringLiteral("Current clip")},
        {QStringLiteral("presentation.apply_to_all"), QStringLiteral("Apply to all selected clips")},
        ...
        {QStringLiteral("presentation.show_notes"), QStringLiteral("Show notes on screen")},
        {QStringLiteral("presentation.export"), QStringLiteral("Export selected clips")},
        ...
        {QStringLiteral("presentation.empty_title"), QStringLiteral("No clips selected")},
        ...
        {QStringLiteral("notes.match_title"), QStringLiteral("Match notes")},
        {QStringLiteral("notes.match_placeholder"),
         QStringLiteral("Match notes… Type @ to mention a clip")},
        {QStringLiteral("notes.clip_title"), QStringLiteral("Clip note")},
        {QStringLiteral("notes.clip_placeholder_none"), QStringLiteral("Select a tag to add a clip note…")},
        {QStringLiteral("notes.mention_empty"), QStringLiteral("No clips to mention")},
        ...
        {QStringLiteral("filter.indicator"), QStringLiteral("Filtered by: ")},
        ...
        {QStringLiteral("vc.tt.mute"), QStringLiteral("shift+m  Mute")},
        {QStringLiteral("vc.tt.unmute"), QStringLiteral("shift+m  Unmute")},
        ...
        {QStringLiteral("export.mixed_events_filename"), QStringLiteral("clips")},
        {QStringLiteral("export.job_dismiss"), QStringLiteral("Dismiss")},
        {QStringLiteral("export.job_path_in_use"),
         QStringLiteral("Another export is already writing to that file.")},
        {QStringLiteral("export.job_cancelled"), QStringLiteral("Export cancelled.")},
        ...
        {QStringLiteral("license.lock.title_trial"), QStringLiteral("Your trial has ended")},
        ...
        {QStringLiteral("license.lock.title_grace"), QStringLiteral("Connect once to refresh")},
        ...
        {QStringLiteral("license.lock.title_expired"), QStringLiteral("This license has expired")},
        ...
        {QStringLiteral("license.lock.title_other_device"), QStringLiteral("This license is on another Mac")},
        ...
        {QStringLiteral("license.lock.title_enter"), QStringLiteral("Enter your license")},
        ...
        {QStringLiteral("license.lock.email"), QStringLiteral("Email:")},
        {QStringLiteral("license.lock.email_placeholder"), QStringLiteral("you@example.com")},
        {QStringLiteral("license.lock.key"), QStringLiteral("License key:")},
        {QStringLiteral("license.lock.key_placeholder"), QStringLiteral("AVA1.…")},
        {QStringLiteral("license.lock.activate"), QStringLiteral("Activate")},
        {QStringLiteral("license.lock.load_file"), QStringLiteral("Load license file…")},
        {QStringLiteral("license.lock.close"), QStringLiteral("Close")},
        {QStringLiteral("license.lock.contact"),
         QStringLiteral("Write to Camila at camilaescudero.cl")},
        {QStringLiteral("license.lock.busy"), QStringLiteral("Checking license…")},
        ...
        {QStringLiteral("license.ok.activated"), QStringLiteral("License activated.")},
        {QStringLiteral("license.status.trial"), QStringLiteral("Trial · %1 days left")},
        {QStringLiteral("license.status.paid"), QStringLiteral("Licensed until %1")},
        {QStringLiteral("license.enter_key"), QStringLiteral("Enter license key")},
  ...
  static const QHash<QString, QString> es = {
      ...
      {QStringLiteral("setup.placeholder_home_team"), QStringLiteral("Equipo local")},
      {QStringLiteral("setup.placeholder_away_team"), QStringLiteral("Equipo visitante")},
      {QStringLiteral("setup.placeholder_hex"), QStringLiteral("#RRGGBB")},
      ...
      {QStringLiteral("setup.optional"), QStringLiteral("Opcional")},
      {QStringLiteral("setup.ai_status_teams"), QStringLiteral("Identificando equipos a partir del nombre de archivo…")},
      {QStringLiteral("setup.ai_status_colors"), QStringLiteral("Detectando colores de camiseta…")},
      {QStringLiteral("setup.color_more"), QStringLiteral("Más colores…")},
      {QStringLiteral("setup.color_choose"), QStringLiteral("Elegir color")},
      {QStringLiteral("setup.color_code"), QStringLiteral("Código de color")},
      {QStringLiteral("setup.color_red"), QStringLiteral("Rojo")},
      {QStringLiteral("setup.color_light_blue"), QStringLiteral("Azul claro")},
      {QStringLiteral("setup.color_dark_blue"), QStringLiteral("Azul oscuro")},
      {QStringLiteral("setup.color_yellow"), QStringLiteral("Amarillo")},
      {QStringLiteral("setup.color_gray"), QStringLiteral("Gris")},
      {QStringLiteral("setup.color_brown"), QStringLiteral("Marrón")},
      {QStringLiteral("setup.color_white"), QStringLiteral("Blanco")},
      {QStringLiteral("setup.color_black"), QStringLiteral("Negro")},
      {QStringLiteral("setup.color_green"), QStringLiteral("Verde")},
      {QStringLiteral("setup.color_pink"), QStringLiteral("Rosa")},
      ...
      {QStringLiteral("mode.presenting"), QStringLiteral("Presentación")},
      ...
      {QStringLiteral("presentation.panel_title"), QStringLiteral("Clips seleccionados")},
      {QStringLiteral("presentation.filter_event"), QStringLiteral("Evento:")},
      {QStringLiteral("presentation.filter_team"), QStringLiteral("Equipo:")},
      {QStringLiteral("presentation.team_all"), QStringLiteral("Ambos")},
      {QStringLiteral("presentation.all_events"), QStringLiteral("Todos los eventos")},
      {QStringLiteral("presentation.select_all"), QStringLiteral("Seleccionar todo")},
      {QStringLiteral("presentation.select_none"), QStringLiteral("Quitar")},
      {QStringLiteral("presentation.selection_summary"),
       QStringLiteral("%1 seleccionados · %2 en lista")},
      {QStringLiteral("presentation.current_clip"), QStringLiteral("Clip actual")},
      ...
      {QStringLiteral("presentation.show_notes"), QStringLiteral("Mostrar notas en pantalla")},
      {QStringLiteral("presentation.export"), QStringLiteral("Exportar clips seleccionados")},
      {QStringLiteral("presentation.keyboard_hint"),
       QStringLiteral("Tab: clip siguiente · Shift+Tab: clip anterior · Espacio: reproducir/pausar · Flechas: avanzar")},
      {QStringLiteral("presentation.empty_title"), QStringLiteral("Selecciona clips en el panel izquierdo")},
      {QStringLiteral("presentation.empty_hint"),
      ...
      {QStringLiteral("tags.note_placeholder"), QStringLiteral("Nota sobre el clip seleccionado…")},
      {QStringLiteral("notes.match_title"), QStringLiteral("Notas del partido")},
      {QStringLiteral("notes.match_placeholder"),
       QStringLiteral("Notas del partido… Escribe @ para mencionar un clip")},
      {QStringLiteral("notes.clip_title"), QStringLiteral("Nota del clip")},
      {QStringLiteral("notes.clip_placeholder_none"),
       QStringLiteral("Selecciona una marca para añadir una nota de clip…")},
      {QStringLiteral("notes.mention_empty"), QStringLiteral("No hay clips para mencionar")},
      ...
      {QStringLiteral("filter.indicator"), QStringLiteral("Filtrado por: ")},
      ...
      {QStringLiteral("vc.tt.forward"), QStringLiteral("⟶  Adelante")},
        ...
        {QStringLiteral("vc.tt.mute"), QStringLiteral("shift+m  Silenciar")},
        {QStringLiteral("vc.tt.unmute"), QStringLiteral("shift+m  Activar audio")},
      ...
      {QStringLiteral("export.note_placeholder"), QStringLiteral("Texto sobre el clip seleccionado…")},
      ...
      {QStringLiteral("export.mixed_events_filename"), QStringLiteral("clips")},
      {QStringLiteral("export.job_dismiss"), QStringLiteral("Cerrar")},
      {QStringLiteral("export.job_path_in_use"),
       QStringLiteral("Otra exportación ya está escribiendo en ese archivo.")},
      {QStringLiteral("export.job_cancelled"), QStringLiteral("Exportación cancelada.")},
      {QStringLiteral("export.no_clips_selected"),
      ...
      {QStringLiteral("license.lock.title_trial"), QStringLiteral("Se acabó tu prueba")},
      {QStringLiteral("license.lock.body_trial"),
      ...
      {QStringLiteral("license.lock.title_grace"), QStringLiteral("Conéctate una vez para actualizar")},
      {QStringLiteral("license.lock.body_grace"),
      ...
      {QStringLiteral("license.lock.title_expired"), QStringLiteral("Esta licencia venció")},
      {QStringLiteral("license.lock.body_expired"),
       QStringLiteral("El etiquetado, la exportación y Presentación están bloqueados. Pídele a Camila una clave nueva.")},
      {QStringLiteral("license.lock.title_other_device"), QStringLiteral("Esta licencia está en otro Mac")},
      {QStringLiteral("license.lock.body_other_device"),
       QStringLiteral("Esa clave ya se usa en otro computador. Escríbele a Camila si cambiaste de Mac.")},
      {QStringLiteral("license.lock.title_enter"), QStringLiteral("Ingresa tu licencia")},
      {QStringLiteral("license.lock.body_enter"),
       QStringLiteral("Pega la clave de licencia que te envió Camila. Después de activarla puedes seguir trabajando sin conexión.")},
      {QStringLiteral("license.lock.email"), QStringLiteral("Email:")},
      {QStringLiteral("license.lock.email_placeholder"), QStringLiteral("tucorreo@ejemplo.com")},
      {QStringLiteral("license.lock.key"), QStringLiteral("Clave de licencia:")},
      {QStringLiteral("license.lock.key_placeholder"), QStringLiteral("AVA1.…")},
      {QStringLiteral("license.lock.activate"), QStringLiteral("Activar")},
      {QStringLiteral("license.lock.load_file"), QStringLiteral("Cargar archivo de licencia…")},
      {QStringLiteral("license.lock.close"), QStringLiteral("Cerrar")},
      {QStringLiteral("license.lock.contact"),
       QStringLiteral("Escríbele a Camila en camilaescudero.cl")},
      {QStringLiteral("license.lock.busy"), QStringLiteral("Comprobando licencia…")},
      {QStringLiteral("license.error.email_and_key"),
      ...
      {QStringLiteral("license.ok.activated"), QStringLiteral("Licencia activada.")},
      {QStringLiteral("license.status.trial"), QStringLiteral("Prueba · %1 días restantes")},
      {QStringLiteral("license.status.paid"), QStringLiteral("Licencia hasta %1")},
      {QStringLiteral("license.enter_key"), QStringLiteral("Ingresar clave de licencia")},
      {QStringLiteral("license.file_filter"),
