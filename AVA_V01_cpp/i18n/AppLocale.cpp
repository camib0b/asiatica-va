...
const QHash<QString, UiTranslation>& uiTranslationTable() {
  static const QHash<QString, UiTranslation> table = {
      ...
      {QStringLiteral("setup.continue_disabled_hint"),
       {QStringLiteral("Enter a name, abbreviation, and color for each team to continue."),
        QStringLiteral("Introduce un nombre, una sigla y un color para cada equipo para continuar.")}},
      ...
      {QStringLiteral("setup.date"), {QStringLiteral("Date"), QStringLiteral("Fecha")}},
      ...
      {QStringLiteral("setup.optional"), {QStringLiteral("Optional"), QStringLiteral("Opcional")}},
      ...
      {QStringLiteral("presentation.selection_summary"),
       {QStringLiteral("%1 selected · %2 listed"),
        QStringLiteral("%1 seleccionados · %2 en lista")}},
