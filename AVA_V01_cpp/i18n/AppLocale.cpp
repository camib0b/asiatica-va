...
QString trUi(const char* key) {
  ...
  if (g_language != Language::Spanish) {
    static const QHash<QString, QString> en = {
        ...
        {QStringLiteral("playback_prep.cancel"), QStringLiteral("Cancel")},
        ...
        {QStringLiteral("xml_import.mapping_col_import"), QStringLiteral("Import")},
  ...
  static const QHash<QString, QString> es = {
      ...
      {QStringLiteral("playback_prep.cancel"), QStringLiteral("Cancelar")},
      {QStringLiteral("playback_prep.error_ffmpeg"),
      ...
      {QStringLiteral("xml_import.mapping_col_import"), QStringLiteral("Importar")},
