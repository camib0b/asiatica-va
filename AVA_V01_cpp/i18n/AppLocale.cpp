...
QString trUi(const char* key) {
  ...
  if (g_language != Language::Spanish) {
    static const QHash<QString, QString> en = {
        ...
        {QStringLiteral("tags.note_placeholder_empty"), QStringLiteral("Select a tag to add a note…")},
  ...
  static const QHash<QString, QString> es = {
      ...
      {QStringLiteral("tags.note_placeholder_empty"), QStringLiteral("Selecciona una marca para añadir una nota…")},
